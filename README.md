...
![\begin{align}
{}\_{5}^{} {SM}\_0^h = {}\_5^{} {RCM}\_0^h \times {}\_{30}^{} {SM}\_{15}^m\\
\\
{}\_{5}^{} {SM}\_0^m = {}\_5^{} {RCM}\_0^m \times {}\_{30}^{} {SM}\_{15}^m
\end{align}](https://latex.codecogs.com/png.image?%5Cbegin%7Balign%7D%0A%7B%7D_%7B5%7D%5E%7B%7D%20%7BSM%7D_0%5Eh%20%3D%20%7B%7D_5%5E%7B%7D%20%7BRCM%7D_0%5Eh%20%5Ctimes%20%7B%7D_%7B30%7D%5E%7B%7D%20%7BSM%7D_%7B15%7D%5Em%5C%5C%0A%5C%5C%0A%7B%7D_%7B5%7D%5E%7B%7D%20%7BSM%7D_0%5Em%20%3D%20%7B%7D_5%5E%7B%7D%20%7BRCM%7D_0%5Em%20%5Ctimes%20%7B%7D_%7B30%7D%5E%7B%7D%20%7BSM%7D_%7B15%7D%5Em%0A%5Cend%7Balign%7D "\begin{align}
{}_{5}^{} {SM}_0^h = {}_5^{} {RCM}_0^h \times {}_{30}^{} {SM}_{15}^m\\
\\
{}_{5}^{} {SM}_0^m = {}_5^{} {RCM}_0^m \times {}_{30}^{} {SM}_{15}^m
\end{align}")
...
> onde:
>
> ![{}\_{5}^{} {SM}\_0^h](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BSM%7D_0%5Eh "{}_{5}^{} {SM}_0^h")
> e
> ![{}\_{5}^{} {SM}\_0^m](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BSM%7D_0%5Em "{}_{5}^{} {SM}_0^m"):
> saldos migratórios de homens (h) e mulheres (m) com idade entre 0 e 4
> anos completos;
>
> ![{}\_{5}^{} {RCM}\_0^h](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BRCM%7D_0%5Eh "{}_{5}^{} {RCM}_0^h")
> e
> ![{}\_{5}^{} {RCM}\_0^m](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BRCM%7D_0%5Em "{}_{5}^{} {RCM}_0^m"):
...
>
> ![{}\_{30}^{} {SM}\_{15}^m](https://latex.codecogs.com/png.image?%7B%7D_%7B30%7D%5E%7B%7D%20%7BSM%7D_%7B15%7D%5Em "{}_{30}^{} {SM}_{15}^m"):
> saldo migratório de mulheres de 15 a 44 anos de idade;

2.  Para a população com idade entre 5 e 9 anos completos:

![\begin{align}
{}\_5^{} {SM}\_5^h = {}\_5^{} {RCM}\_5^h \times {}\_{30}^{} {SM}\_{20}^m\\
\\
{}\_5^{} {SM}\_5^m = {}\_5^{} {RCM}\_5^m \times {}\_{30}^{} {SM}\_{20}^m
\end{align}](https://latex.codecogs.com/png.image?%5Cbegin%7Balign%7D%0A%7B%7D_5%5E%7B%7D%20%7BSM%7D_5%5Eh%20%3D%20%7B%7D_5%5E%7B%7D%20%7BRCM%7D_5%5Eh%20%5Ctimes%20%7B%7D_%7B30%7D%5E%7B%7D%20%7BSM%7D_%7B20%7D%5Em%5C%5C%0A%5C%5C%0A%7B%7D_5%5E%7B%7D%20%7BSM%7D_5%5Em%20%3D%20%7B%7D_5%5E%7B%7D%20%7BRCM%7D_5%5Em%20%5Ctimes%20%7B%7D_%7B30%7D%5E%7B%7D%20%7BSM%7D_%7B20%7D%5Em%0A%5Cend%7Balign%7D "\begin{align}
{}_5^{} {SM}_5^h = {}_5^{} {RCM}_5^h \times {}_{30}^{} {SM}_{20}^m\\
\\
{}_5^{} {SM}_5^m = {}_5^{} {RCM}_5^m \times {}_{30}^{} {SM}_{20}^m
\end{align}")
...
> onde:
>
> ![{}\_{5}^{} {SM}\_5^h](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BSM%7D_5%5Eh "{}_{5}^{} {SM}_5^h")
> e
> ![{}\_{5}^{} {SM}\_5^m](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BSM%7D_5%5Em "{}_{5}^{} {SM}_5^m"):
> saldos migratórios de homens (h) e mulheres (m) com idade entre 5 e 9
> anos completos;
>
> ![{}\_{5}^{} {RCM}\_5^h](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BRCM%7D_5%5Eh "{}_{5}^{} {RCM}_5^h")
> e
> ![{}\_{5}^{} {RCM}\_5^m](https://latex.codecogs.com/png.image?%7B%7D_%7B5%7D%5E%7B%7D%20%7BRCM%7D_5%5Em "{}_{5}^{} {RCM}_5^m"):
> relações, ao final da década, entre crianças (homens e mulheres
> respectivamente) com 5 a 9 anos de idade completos e mulheres de 20 a
> 49 anos de idade completos;
>
> ![{}\_{30}^{} {SM}\_{20}^m](https://latex.codecogs.com/png.image?%7B%7D_%7B30%7D%5E%7B%7D%20%7BSM%7D_%7B20%7D%5Em "{}_{30}^{} {SM}_{20}^m"):
...
![1/4](https://latex.codecogs.com/png.image?1%2F4 "1/4") seria devido
aos efeitos diretos e
![3/4](https://latex.codecogs.com/png.image?3%2F4 "3/4") aos indiretos.
No grupo de 5 a 9 anos, os coeficientes de separação seriam,
respectivamente,
![3/4](https://latex.codecogs.com/png.image?3%2F4 "3/4") e
![1/4](https://latex.codecogs.com/png.image?1%2F4 "1/4").
